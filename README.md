...
1. You need a set of *Application Keys* to connect with **Voucherify Platform**. Visit App.
...
* Found a bug? Have a suggestion for improvement? Want to tell us we're awesome? [**Submit an issue**](https://github.com/voucherifyio/voucherify-publish-app/issues/new)
...
* Want to contribute? [**Submit a pull request**](https://github.com/voucherifyio/voucherify-publish-app/compare)
